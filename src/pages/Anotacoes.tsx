...
const Anotacoes = () => {
  ...
  const [newNote, setNewNote] = useState({ title: "", content: "", linkedTo: "" });
    ...
    <div className="container mx-auto">
      ...
      <div className="mb-8">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            />
            <Textarea 
              placeholder="Conteúdo da anotação... Use #tags para organizar" 
            ...
            <div className="flex gap-2 items-center">
              ...
              <Input 
                placeholder="Vincular a um material (opcional)" 
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="relative w-full max-w-md">
          ...
          <Input 
            className="pl-10" 
            placeholder="Buscar em anotações ou #tags" 
            value={searchTerm}
        ...
        {filteredNotes.map(note => (
          <Card key={note.id}>
            <CardHeader>
                    ...
                    <PopoverContent className="w-auto p-0" align="end">
                      ...
                      <div className="p-3 border-t border-border">
                        <Button 
                          size="sm" 
                          className="w-full"
                          onClick={() => handleAddToCalendar(note)}
                        >
              ...
              <CardDescription>
                {format(note.createdAt, "dd/MM/yyyy", { locale: ptBR })} 
