...
const Questoes = () => {
  ...
  return <div className="container mx-auto py-8 px-[9px]">
      ...
      duration: 0.3
        ...
        <h1 className="text-2xl font-bold flex items-center px-0 mx-0 my-0">
          <BookOpen className="mr-2 h-6 w-6 text-primary" />
          Banco de Questões
        </h1>
      ...
      <AnimatePresence>
        ...
        duration: 0.2
            ...
            <Button variant="default" size="icon" className="rounded-full h-12 w-12 shadow-lg gradient-purple" onClick={scrollToTop} title="Voltar ao topo">
              <ArrowUp size={20} />
            </Button>
          </motion.div>}
      </AnimatePresence>
