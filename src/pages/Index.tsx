...
import { Scale, Video, BookOpen, Brain, GraduationCap, FilePlus, MessageSquare, LibrarySquare, Gavel, Newspaper, FileText, PenTool, Monitor, Search } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="container mx-auto py-0 px-px">
      <div className="flex flex-col items-center text-center mb-8">
        <div className="mb-4">
          ...
          <div className="md:hidden w-full max-w-lg mx-auto mb-6">
            <SearchBar />
          </div>
        </div>
      </div>
