...
export function ImmersivePodcastPlayer({
  ...
  useEffect(() => {
    ...
    const mockComments = [
      ...
      {
        id: '2',
        user: { name: 'Paulo Mendes', avatar: 'https://i.pravatar.cc/150?img=2' },
  ...
  const handleAddComment = () => {
    ...
    const newComment = {
      ...
      user: { name: user.email?.split('@')[0] || 'Usuário', avatar: undefined },
      text: commentText,
    ...
    >
      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
          ...
          <TabsContent value="visualizer" className="p-4 h-full flex items-center justify-center overflow-hidden">
            <motion.div 
            ...
            >
              ...
              <div className="relative mx-auto rounded-lg overflow-hidden aspect-square max-w-xs mb-6">
                ...
                <div className="absolute inset-0 backdrop-blur-sm bg-gradient-to-b from-transparent to-black/40 flex items-center justify-center">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button 
              size="icon"
              className="h-10 w-10 rounded-full bg-purple-600 hover:bg-purple-500"
              onClick={togglePlayPause}
            >
              {isPlaying ? (
