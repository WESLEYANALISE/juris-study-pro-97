...
export function FlashcardView({ 
  ...
  return (
    <div className={cn("flex flex-col items-center", fullWidth ? "w-full" : "")}>
      ...
      >
        <Card 
          className="relative bg-gradient-to-br from-card via-[#9b87f510] to-card shadow-md border border-primary/10 rounded-xl overflow-hidden"
          style={{ minHeight: 360 }}
        >
              ...
              {showAnswer ? (
                <div className="flex flex-col items-center w-full">
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className="text-xl bg-gradient-to-br from-[#D6BCFA10] to-[#FFF] py-6 px-7 rounded-lg text-foreground font-medium border border-primary/15 text-center mb-6 w-full shadow-sm"
                  >
                    {flashcard.resposta}
                  </motion.div>
