...
interface AIRecommendationsProps {
  askAiForRecommendation: (query: string) => Promise<{ result: string; books: Book[] }>;
  books: Book[];
  openBookDialog: (book: Book) => void;
}

const AIRecommendations: React.FC<AIRecommendationsProps> = ({ askAiForRecommendation, books, openBookDialog }) => {
