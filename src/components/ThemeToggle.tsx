  ...
  return (
    <motion.div whileTap={{ scale: 0.95 }}>
      <Button
        ...
        size="icon"
        onClick={handleClick}
        className="relative w-9 h-9 rounded-full hover:bg-purple-900/20 transition-all duration-300"
      >
        {/* App logo instead of scale icon */}
        <img 
          src="/logo-sm.svg" 
          alt="Logo" 
          className="w-6 h-6 transition-all duration-300 hover:animate-pulse"
        />
